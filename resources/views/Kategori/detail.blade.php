...
@section('content')
    <div class="card">
        ...
        <div class="d-flex justify-content-end">
            <a href="/kategori" class="btn btn-outline-danger mx-3 my-3">Kembali</a>
        </div>
    </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="detai-buku">
                                <h5 class="card-title text-primary">
                                    <a href="/buku/{{ $item->id }}"style="text-decoration: none; font-size:1rem;font-weight:bold;text-align=center;">
                                        {{ $item->judul }}</a></h5>
