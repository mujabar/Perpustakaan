...
@section('content')
    ...
    <div class="container">
        <a href="/peminjaman/create" class="btn btn-outline-success mb-3 "><i class="fa-solid fa-plus"></i> tambah</a>
        <a href="/cetaklaporan" class="btn btn-outline-danger mb-3 mx-2"><i class="fa-solid fa-print"></i> Cetak</a>
    </div>
